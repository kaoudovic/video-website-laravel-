...
class HomeController extends Controller
{
    ...
    public function category($id){
        $cat=Category::findOrFail($id);//cat_id the name of relation between category and videos
    ...
    public function video($id){
        $video=Video::published()->with('skills','tags','cat','user','comments.user')->findOrFail($id);//cat_id the name of
        // relation between category and videos
        return view('front-end.video.index', compact('video'));

    }

    public function skills($id){
        $skill=Skill::findOrFail($id);//cat_id the name of relation between category and videos
    ...
    public function tags($id){
        $tag=Tag::findOrFail($id);//cat_id the name of relation between category and videos
    ...
    public function messageStore(\App\Http\Requests\FrontEnd\Messages\Store $request){
        ...
        return redirect()->route('frontend.landing');// wellcome page
