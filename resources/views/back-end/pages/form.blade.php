...
@error($input) is-invalid @enderror">
    ...
    <div class="col-md-12">
        <div class="form-group bmd-form-group">
            ...
            <textarea name=" {{$input}}" class="form-control @error($input) is-invalid @enderror" id="" cols="30" rows="10">{{ isset($row) ? $row->{$input} : '' }} </textarea>
            @error($input)
            <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
            </span>
    ...
    <div class="col-md-12">
        <div class="form-group bmd-form-group">
            ...
            <textarea name=" {{$input}}" class="form-control @error($input) is-invalid @enderror" id="" cols="30"
